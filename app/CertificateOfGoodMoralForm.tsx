...
const fields = [
  ...
  },
  {
    name: "purpose",
    label: "Purpose",
    placeholder: "Employment, School Requirement, etc.",
    required: true,
    multiline: true,
    numberOfLines: 3,
...
const CertificateOfGoodMoralForm = () => {
  ...
  const handleSubmit = async (values: Record<string, string>) => {
    ...
    try {
      ...
      router.push({
        pathname: "/payment",
        params: {
          documentName: "Certificate of Good Moral Character",
          requestId: data.id,
          firstName,
          lastName: rest.join(" "),
          completeAddress: "",
  ...
  return (
    <DocumentFormShell
      ...
      subtitle="Provide your residency and purpose details."
      documentHint="This screen stores good moral requests separately for backend processing."
      fields={fields}
...
export default CertificateOfGoodMoralForm;
