...
const fields = [
  ...
  },
  {
    name: "purpose",
    label: "Purpose",
    placeholder: "Select or state the purpose",
    required: true,
    multiline: true,
    numberOfLines: 3,
...
const CertificateOfIndigencyForm = () => {
  ...
  return (
    <DocumentFormShell
      ...
      documentHint="This screen stores indigency requests separately for backend processing."
      fields={fields}
