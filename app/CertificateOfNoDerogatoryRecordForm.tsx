...
const CertificateOfNoDerogatoryRecordForm = () => {
  ...
  const handleSubmit = async (values: Record<string, string>) => {
    ...
    try {
      ...
      const uploadResult = await uploadRequestAttachment({
        fileUri: idFileUri,
        fileName: idFileName,
        folder: "certificate-no-derogatory",
      });
      ...
      router.push({
        pathname: "/payment",
        params: {
          documentName: "Certificate of No Derogatory Record",
          requestId: data.id,
          firstName,
          lastName: rest.join(" "),
  ...
  return (
    <DocumentFormShell
      title="Request No Derogatory Record"
      subtitle="Provide your details and upload a valid ID."
      documentHint="This screen stores no-derogatory-record requests separately for backend processing."
      fields={fields}
...
export default CertificateOfNoDerogatoryRecordForm;
