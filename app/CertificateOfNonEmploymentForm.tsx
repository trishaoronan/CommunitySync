...
const CertificateOfNonEmploymentForm = () => {
  ...
  const handleSubmit = async (values: Record<string, string>) => {
    ...
    try {
      ...
      const uploadResult = await uploadRequestAttachment({
        fileUri: idFileUri,
        fileName: idFileName,
        folder: "certificate-non-employment",
      });
      ...
      const { data, error } = await createDocumentRequest({
        documentType: "Certificate of Non-Employment",
        requestDetails,
      ...
      router.push({
        pathname: "/payment",
        params: {
          documentName: "Certificate of Non-Employment",
          requestId: data.id,
          firstName,
          lastName: rest.join(" "),
          completeAddress: "",
  ...
  return (
    <DocumentFormShell
      title="Request Certificate of Non-Employment"
      subtitle="Provide income details and upload a valid ID."
      documentHint="This screen stores non-employment requests separately for backend processing."
      fields={fields}
...
export default CertificateOfNonEmploymentForm;
