  ...
  return (
    <ThemeProvider value={colorScheme === 'dark' ? DarkTheme : DefaultTheme}>
      <Stack>
        ...
        <Stack.Screen name="resident-dashboard" options={{ headerShown: false }} />
        <Stack.Screen name="request-document" options={{ headerShown: false }} />
        ...
        <Stack.Screen name="track-request-detail" options={{ headerShown: false }} />
        ...
        <Stack.Screen name="verify-phone-number" options={{ headerShown: false }} />
        <Stack.Screen name="verify-otp" options={{ headerShown: false }} />
        <Stack.Screen name="login-credentials" options={{ headerShown: false }} />
