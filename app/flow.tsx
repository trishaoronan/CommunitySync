...
const WelcomeScreen = ({ onSignIn, onCreateAccount }: { onSignIn: () => void; onCreateAccount: () => void }) => {
  return (
...
const SignInScreen = ({ onBack, onSignInSuccess }: { onBack: () => void; onSignInSuccess: () => void }) => {
    ...
    <LinearGradient colors={['#EEF4FD', '#FDFFED']} style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.securityBadge}>
          ...
          <Text style={styles.securityText}>Secured login powered by CommunitySynс</Text>
        </View>
...
export default function AppFlow() {
  ...
  if (currentScreen === 'Welcome') {
    return <WelcomeScreen onSignIn={handleSignIn} onCreateAccount={handleCreateAccount} />;
  }

  if (currentScreen === 'Registration') {
    return <RegistrationFlow onComplete={handleRegistrationComplete} onBack={handleRegistrationBack} />;
  }

  if (currentScreen === 'SignIn') {
    return <SignInScreen onBack={handleBackFromSignIn} onSignInSuccess={handleSignInSuccess} />;
  }
}
