...
const SettingsScreen = () => {
  ...
  const accountSettings: SettingsItem[] = [
    ...
    { id: '2', label: 'Verify Phone Number', icon: 'call', iconType: 'material' },
    { id: '3', label: 'My Request', icon: 'description', iconType: 'material' },
    { id: '4', label: 'Login Credentials', icon: 'vpn-key', iconType: 'material' },
  ];

  const privacySettings: SettingsItem[] = [
    { id: '5', label: 'Change Password', icon: 'lock', iconType: 'material' },
    { id: '6', label: 'Biometric Login', icon: 'fingerprint', iconType: 'material' },
    { id: '7', label: 'Privacy Policy', icon: 'privacy-tip', iconType: 'material' },
    { id: '8', label: 'Data & Storage', icon: 'cloud-download', iconType: 'material' },
  ];

  const generalSettings: SettingsItem[] = [
    { id: '9', label: 'Language', icon: 'globe', iconType: 'material' },
    { id: '10', label: 'Terms & Conditions', icon: 'description', iconType: 'material' },
